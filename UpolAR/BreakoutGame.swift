...
//  UpolAR
//
//  Created by Dalibor Janeček on 20.11.2021.
//

import SpriteKit

class BreakoutGame: SKScene, SKPhysicsContactDelegate, ObservableObject {
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        paddle.position = CGPoint(x: location.x, y: 60)
    ...
    func makeBall() {
        ...
        ball.position = CGPoint(x: UIScreen.main.bounds.width/2, y: UIScreen.main.bounds.height/2)
    ...
    func makePaddle() {
        paddle.name = "paddle"
        paddle.position = CGPoint(x: UIScreen.main.bounds.width/2, y: 60)
    ...
    func makeBricks() {
        ...
        let rows = [
            Row(color: .red, positionY: UIScreen.main.bounds.height-topPadding),
            Row(color: .red, positionY: UIScreen.main.bounds.height-topPadding-yOffset),
            Row(color: .orange, positionY: UIScreen.main.bounds.height-topPadding-yOffset*2),
            Row(color: .orange, positionY: UIScreen.main.bounds.height-topPadding-yOffset*3),
            Row(color: .green, positionY: UIScreen.main.bounds.height-topPadding-yOffset*4)
        ]
