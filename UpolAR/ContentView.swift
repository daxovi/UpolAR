...
struct ContentView: View {
    ...
    @State private var isPressedCompass = false
    @State private var isPressedPortal = false
    @State private var isLocationSheetShown = false
    ...
    var body: some View {
        NavigationView {
            List {
                ...
                Button {
                    isPressedCompass.toggle()
                } label: {
                    Text("AR Navigator")
                }
                .fullScreenCover(isPresented: $isPressedCompass) {
                    ARCompassView()
                }
